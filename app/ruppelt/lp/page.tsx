...
const ruppeltLpSocialUrl = `${siteUrl}/ruppelt/lp?xcard=v40`;

const metaTitle = "Ruppelt V4.0｜アメリカ政府UAP・UFO公開資料375件を日本語で検索";
...
const ruppeltLpJsonLd = {
  ...
  "@type": "WebApplication",
  name: "Ruppelt V4.0",
  alternateName: "Ruppelt V4.0 - アメリカ政府UAP・UFO公開資料ビューアー",
