...
const ruppeltLpSocialUrl = `${siteUrl}/ruppelt/lp?xcard=v30`;

const metaTitle = "Ruppelt V3.0｜アメリカ政府UAP・UFO機密解除資料を日本語で検索";
...
const ruppeltLpJsonLd = {
  ...
  "@type": "WebApplication",
  name: "Ruppelt V3.0",
  alternateName: "Ruppelt V3.0 - アメリカ政府UAP・UFO機密解除資料ビューアー",
  applicationCategory: "ReferenceApplication",
  operatingSystem: "Web",
  url: appUrl,
  inLanguage: "ja-JP",
  description: metaDescription,
  image: ruppeltOgpImage,
  creator: {
    "@type": "Organization",
    name: siteName,
    url: siteUrl,
