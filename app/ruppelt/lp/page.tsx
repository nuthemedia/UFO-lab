...
const ruppeltLpSocialUrl = `${siteUrl}/ruppelt/lp?xcard=v45`;

const metaTitle = "Ruppelt V4.5｜アメリカ政府UAP・UFO公開資料446件を日本語で検索";
...
const ruppeltLpJsonLd = {
  ...
  "@type": "WebApplication",
  name: "Ruppelt V4.5",
  alternateName: "Ruppelt V4.5 - アメリカ政府UAP・UFO公開資料ビューアー",
